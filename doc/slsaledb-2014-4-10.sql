...
/*后期调试添加的内容，2017年7月21日整理更新-------start*/
...
VALUES (94,'recharge','汇款充值','/elecbank/recharge.html',3,'2014-04-04 15:03:24'),
       ...
       (100,'awardQuery','奖励查询','/infoquery/awardQuery.html',5,'2014-04-04 15:03:24'),
	   ...
	   (104,'customsPurchase','报单购货','/shopping/customsPurchase.html',4,'2014-04-04 15:03:24'),
...
#更新au_function表的id=68的字段值:获取用户
UPDATE `au_function` SET funcUrl='/backend/getuser.shtml' WHERE `id`=68;  
#修改提现表主键ID类型 为bigint 改为自增
ALTER TABLE `user_cash` CHANGE `CASH_ID` `CASH_ID` BIGINT(32) NOT NULL AUTO_INCREMENT COMMENT 'CASH_ID';

/*后期调试添加的内容，2017年7月21日整理更新-------end*/ 
