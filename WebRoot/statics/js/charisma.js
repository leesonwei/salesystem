				...
				function() {
				   ...
				   // alert(tt);
					...
					for ( var i = 0; i < json.length; i++) {
						 ...
						 * class="hidden-tablet">用户管理</span></a></li> <li><a
						 * class="ajax-link" href="ui.html"><i
						 * class="icon-eye-open"></i><span
						 * class="hidden-tablet">角色管理</span></a></li> <li><a
						 * class="ajax-link" href="form.html"><i
						 * class="icon-edit"></i><span class="hidden-tablet">
						 * 权限管理</span></a></li> <li><a class="ajax-link"
						 * href="chart.html"><i class="icon-list-alt"></i><span
						 * class="hidden-tablet">商品管理</span></a></li> <li><a
						 * class="ajax-link" href="typography.html"><i
						 * class="icon-font"></i><span
						 * class="hidden-tablet">商品套餐管理</span></a></li> <li><a
						 * class="ajax-link" href="gallery.html"><i
						 * class="icon-picture"></i><span
						 * class="hidden-tablet">基础信息</span></a></li> <li><a
						 * class="ajax-link" href="gallery.html"><i
						 * class="icon-picture"></i><span
						 * class="hidden-tablet">数据字典</span></a></li> </ul>
						 * </li>
						 */

						// config main menu
						result = result
								+ '<li class="nav-header hidden-tablet" onclick="$(\'#test'
								+ i
								+ '\').toggle(500);" style="cursor:pointer;">'
								+ json[i].mainMenu.functionName + '</li>';
						// config sub menus
						result = result
								+ "<li><ul class=\"nav nav-tabs nav-stacked\" id=\"test"
								+ i + "\">";
						...
						for ( var j = 0; j < json[i].subMenus.length; j++) {
							...
							result = result
									+ "<li><a class=\"ajax-link\" style=\"cursor:pointer;\" href=\""+path
									+ json[i].subMenus[j].funcUrl
									+ "\"><i class=" + pic
									+ "></i><span class=\"hidden-tablet\">"
									+ json[i].subMenus[j].functionName
									+ "</span></a></li>";
						}
						result = result + "</ul></li>";
					}
...
function docReady() {
	...
	// datatable
	/*
	 * $('.datatable').dataTable({ "sDom": "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span12'i><'span12
	 * center'p>>", "sPaginationType": "bootstrap", "oLanguage": {
