...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath}/backend/rolelist.html">角色管理</a>
		</li>
	</ul>
</div>
					...
					<c:forEach items="${roleList}" var="role">
						<tr>
							...
							<td class="center"><input type="checkbox"
								title="直接勾选修改状态，立即生效" data-rel="tooltip" class="modifyIsStart"
							...
							<td class="center">
							   <a class="btn btn-info modifyrole"
									...
									roleid="${role.id}" href="#"> <i class="icon-edit icon-white"></i> 修改 
							   </a> 
							   <a class="btn btn-danger delrole" rolename="${role.roleName}"
								    roleid="${role.id}" href="#"> <i class="icon-trash icon-white"></i> 删除 
							   </a>
							</td>
						</tr>
					</c:forEach>
