...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath}/backend/goodsinfolist.html">商品管理</a></li>
	</ul>
</div>
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
		    <!-- 查询部分start -->
			<form action="${pageContext.request.contextPath}/backend/goodsinfolist.html" method="post">
					...
					<c:if test="${page.items != null}">
						<c:forEach items="${page.items}" var="goodsInfo">
							<tr>
								...
								<td class="center"><fmt:formatDate value="${goodsInfo.lastUpdateTime}" pattern="yyyy-MM-dd" /></td>
								<td class="center">
								    <a class="btn btn-success viewgoodsinfo" href="#" id="${goodsInfo.id}"><i class="icon-zoom-in icon-white"></i> 查看 </a> 
								    <a class="btn btn-info modifygoodsinfo" href="#" id="${goodsInfo.id}"><i class="icon-edit icon-white"></i>修改 </a> 
								    <a class="btn btn-danger delgoodsinfo" href="#" id="${goodsInfo.id}" goodsName="${goodsInfo.goodsName}"><i class="icon-trash icon-white"></i> 删除 </a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
			...
			<div class="pagination pagination-centered">
				<ul>
					<c:choose>
						...
						<c:otherwise>
							<li><a
								href="${pageContext.request.contextPath}/backend/goodsinfolist.html?currentpage=1&s_goodsName=${s_goodsName}&s_state=${s_state}"
								title="首页">首页</a>
							</li>
						</c:otherwise>
					</c:choose>
					...
					<c:if test="${page.prevPages!=null}">
						<c:forEach items="${page.prevPages}" var="num">
							<li><a
								href="${pageContext.request.contextPath}/backend/goodsinfolist.html?currentpage=${num}&s_goodsName=${s_goodsName}&s_state=${s_state}"
					...
					<c:if test="${page.pageCount !=null}">
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="${pageContext.request.contextPath}/backend/goodsinfolist.html?currentpage=${page.pageCount}&s_goodsName=${s_goodsName}&s_state=${s_state}"
									title="尾页">尾页</a>
								</li>
							</c:otherwise>
						</c:choose>
...
<div class="modal hide fade" id="addGoodsInfoDiv">
	<form action="${pageContext.request.contextPath}/backend/addgoodsinfo.html" enctype="multipart/form-data"
		...
		<div class="modal-body">
			...
			<ul class="topul">
				<li>
				   <label>商品名称：</label>
				   <input type="text" id="a_goodsName" name="goodsName" /><span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				   <label>商品编号：</label>
				   <input type="text" id="a_goodsSN" name="goodsSN" /><span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				   <label>市场价：</label> 
				   <input type="text" id="a_marketPrice"
					name="marketPrice"
				...
				<li>
				   <label>优惠价：</label> 
				   <input type="text" id="a_realPrice"
					name="realPrice"
					onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;" />
					<span style="color:red;font-weight: bold;">*</span>
				</li>
...
<div class="modal hide fade" id="modifyGoodsInfoDiv">
	<form action="${pageContext.request.contextPath}/backend/modifygoodsinfo.html"
		...
		<div class="modal-body">
			...
			<ul class="topul">
				<li>
				    <label>商品名称：</label>
				    <input type="text" id="m_goodsName" name="goodsName" /><span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				    <label>商品编号：</label>
				    <input type="text" id="m_goodsSN" name="goodsSN" /><span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				    <label>市场价：</label>
				    <input type="text" id="m_marketPrice"
					name="marketPrice"
					onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;" />
					<span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				    <label>优惠价：</label> 
				    <input type="text" id="m_realPrice"
					name="realPrice"
					onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;" />
					<span style="color:red;font-weight: bold;">*</span>
				</li>
				<li>
				    <label>库存量：</label>
				    <input type="text" id="m_num" name="num"
					onkeyup="this.value=this.value.replace(/\D/g,'')"
					onafterpaste="this.value=this.value.replace(/\D/g,'')" /> 
					<span style="color:red;font-weight: bold;">*</span>
				</li>
...
<div class="modal hide fade" id="viewGoodsInfoDiv">
	...
	<div class="modal-body">
		<ul class="topul">
			<li>
			    <label>商品名称：</label>
			    <input type="text" id="v_goodsName" name="goodsName" readonly="readonly" />
			</li>
			<li>
			    <label>商品编号：</label>
			    <input type="text" id="v_goodsSN" name="goodsSN" readonly="readonly" />
			</li>
			<li>
			    <label>市场价：</label>
			    <input type="text" id="v_marketPrice" name="marketPrice" readonly="readonly" />
		    </li>
			<li>
			    <label>优惠价：</label> 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/localjs/goodsinfolist.js"></script>
