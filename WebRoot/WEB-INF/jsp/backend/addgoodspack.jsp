...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath}/backend/addgoodspack.html">添加商品套餐</a>
		</li>
	</ul>
</div>
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			...
			<form action="${pageContext.request.contextPath}/backend/saveaddgoodspack.html" class="form-horizontal"
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/localjs/addgoodspack.js"></script>
