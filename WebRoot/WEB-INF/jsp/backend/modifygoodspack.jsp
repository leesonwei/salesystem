...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			...
			<form action="${pageContext.request.contextPath}/backend/savemodifygoodspack.html"
						...
						<select id="m_typeId" name="typeId" style="width:100px;">
							...
							<c:if test="${packTypeList != null}">
								<c:forEach items="${packTypeList}" var="packType">
									<option <c:if test="${goodsPack.typeId == packType.valueId}">selected = "selected"</c:if> value="${packType.valueId}"> ${packType.valueName} </option>
								</c:forEach>
							</c:if>
						</select> 
						<span style="color:red;font-weight: bold;">*</span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="m_num" name="num" value="${goodsPack.num}"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="m_totalPrice" name="totalPrice"
							value="${goodsPack.totalPrice}"
							    ...
							    <c:if test="${goodsList != null}">
									<c:forEach items="${goodsList}" var="goods">
										<div id="selectdiv">
											...
											<label class="goodscount"><input class="finalresult"
												goodsid="${goods.goodsInfoId}" rprice="${goods.realPrice}"
												type="text" value="${goods.goodsNum}" />
											</label> 
