     ...
     <div class="row-fluid sortable">
          <div class="box span12">
               ...
               <div class="box-content">
                    <table style="width:100%;" id="inforTable">
                    	<tr><th></th><th style="text-align:left;">文件标题</th><th style="text-align:left;">文件格式</th><th style="text-align:left;">文件大小M</th><th style="text-align:left;">最后修改时间</th></tr>
                         <c:if test="${informationList != null}">
                               <c:forEach items="${informationList}" var="information">
                                   <tr>
                                       ...
                                       <td><a class="viewdownload" id="${information.id}" href="${pageContext.request.contextPath}/${information.filepath}">${information.title}</a></td>
...
<script src="${pageContext.request.contextPath}/statics/localjs/information/download.js"></script>